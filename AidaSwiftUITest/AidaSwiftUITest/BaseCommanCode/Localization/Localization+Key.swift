...
public enum LocalizationKey: String {
    ...
    //MARK: SPORTS DISPLAY
    case sportDisplayChooseArrangeDesc
    case selectedSports
    case selectedSportsLimitReached
    
    //MARK: SPORTS TYPE
    ///SPORT CATEGORIES
    case basicSports
    case ballSports
    case workoutTraining
    case leisureSports
    case iceSports
    case waterSports
    case extremeSports
    ...
    case organizeAndRelax
    case traditionalStrengthTraining
    case openingAndClosingJump
    case squat
    case highLegLift
    case freeFight
    case artisticGymnastics
    case walkingMachine
    case mountaineeringMachine
    case rugby
    case softball
    case shuttlecock
    case beachSoccer
    ...
    case skate
    case footvolley
    case standWaterSkiing
    case crossCountryRun
    case rolledAbdomen
    case bobbyJump
    case kabaddi
    case outdoorFun
